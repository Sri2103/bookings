...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		helpers.ServerError(w, errors.New("cannot get reservation data from from the session"))
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		...
		m.App.ErrorLog.Println("Cannot get the error from session")
...
//BookRoom takes URL parameters, builds session variables and takes user to make reservation screen
